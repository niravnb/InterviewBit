...
// void print(vector<vector<int>> &dp_cut, int i, int j){

//     if((i+1)>=j) return;
//     res.push_back(dp_cut[i][j]);
//     print(dp_cut,i,dp_cut[i][j]);
//     print(dp_cut,dp_cut[i][j],j);

// }

// long long int solveit(vector<vector<long long int>>& dp,vector<int> &cuts,vector<vector<int>> &dp_cut,int l, int r){
    
//     if(l+1>=r) return 0;
    
//     if(dp[l][r]!=-1) return dp[l][r];
    
//     long long int tmp = LLONG_MAX;
//     int ind=  -1;
//     for(int i=l+1;i<r;i++){
//         long long int t = cuts[r] - cuts[l] + solveit(dp,cuts,dp_cut,l,i) + solveit(dp,cuts,dp_cut,i,r);
//         if(tmp>t){
//             tmp = t;
//             ind = i;
//         }
...
//     vector<vector<int>> dp_cut(n, vector<int>(n));
    
    
    
//     solveit(dp,cuts,dp_cut,0,n-1);
//     res.clear();
//     print(dp_cut,0,n-1);
//     return res;
// }
